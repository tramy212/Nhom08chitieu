...
public class ThemMoiDanhMucActivity extends AppCompatActivity implements DanhMucMauAdapter.OnItemClickListener {
    ...
    private void loadDanhMucMau() {
        ...
        danhMucMauList.add(new DanhMucMauModel(4, "Hóa Đơn", "bill", "#87CEFA")); // Thay "Hóa Đơn Điện" thành "Hóa Đơn"
        ...
        danhMucMauList.add(new DanhMucMauModel(13, "Lương", "salary", "#87CEFA"));
